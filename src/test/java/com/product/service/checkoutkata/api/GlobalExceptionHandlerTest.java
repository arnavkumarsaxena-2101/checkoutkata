...
class GlobalExceptionHandlerTest {
  ...
  static class StubController {
    ...
    record Payload(@NotBlank(message = "items is required") String items) {}
  ...
  void validationMappedTo400() throws Exception {
    ...
    mvc()
        .perform(post("/stub/validate").contentType(MediaType.APPLICATION_JSON).content(badJson))
  ...
  void validPayloadPasses() throws Exception {
    ...
    mvc()
        .perform(post("/stub/validate").contentType(MediaType.APPLICATION_JSON).content(goodJson))
