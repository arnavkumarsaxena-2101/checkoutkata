...
public class CheckoutControllerTest {
    ...
    class HappyPaths {
        ...
        void shouldComputeTotalsAndCounts(String items, BigDecimal stubTotal, Map<String,Integer> expectedCounts) throws Exception {
            when(checkoutService.priceOf(items)).thenReturn(stubTotal);

            mvc.perform(post("/api/v1/checkout/price")
                    ...
                    .andExpectAll(expectedCounts.entrySet().stream()
